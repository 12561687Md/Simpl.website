...
6. **Default to gain-framing** (2026-07-23, softens the old cost-of-inaction rule): lean toward the upside, "win an extra $X/month," "wins waiting," "fastest wins," headline dollar figures in accent/green not alarm-red. Not a ban: keep honest loss language where an owner genuinely needs to know what's at stake (broken form eating leads, missed emergency calls). True stakes are information; fear as a reflex is what to avoid.
...
**The phone (PhoneLoop):** opens with the vital-sign pulse-logo loading animation (checks ticking in), then auto-cycles its report tabs (score gauge, category grades, who's ranking above you) with progress dots, no user scrolling. Status bar time is 9:47. Dark app screen on the brand palette (a light version was tried 2026-07-23 and reverted same day at Matt's call). Sits on a soft accent glow.
