...
export default function FixYourBusinessPage() {
  return (
    <main className="start-split">
      {/* LEFT: logo (top middle) -> branded composite -> search */}
      <section className="start-panel start-left" style={{ textAlign: "center" }}>
        <Link href="/" aria-label="Simpl home" style={{ display: "inline-flex", marginBottom: 20 }}>
          <SimplWordmark size={26} />
        </Link>

        <SimplComposite />

        <div style={{ maxWidth: 460, margin: "34px auto 0", width: "100%", textAlign: "left" }}>
          <div className="mono" style={{ fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(255,255,255,0.85)", marginBottom: 10, textAlign: "center" }}>
            Find your business to start your free demo
          </div>
          <StartSearch />
        </div>
      </section>
