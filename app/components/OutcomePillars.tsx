...
export default function OutcomePillars() {
  return (
    <section style={{ position: "relative" }}>
      <div style={{ maxWidth: 1120, margin: "0 auto", padding: "104px 32px" }}>
        <ScrollReveal>
        ...
        >
          {PILLARS.map((p, i) => (
            <StaggerItem key={p.label}>
              <div
                className={`surface-card${i === 0 ? " glow-hover is-featured" : " glow-hover"}`}
                style={{ height: "100%", padding: "32px 28px 30px", display: "flex", flexDirection: "column" }}
              >
                <div
                  style={{
                    width: 46,
                ...
                <h3 style={{ margin: "0 0 12px", fontSize: 21, fontWeight: 500, lineHeight: 1.25, letterSpacing: "-0.01em" }}>
                  {p.headline}
                </h3>
