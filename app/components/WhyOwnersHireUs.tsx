...
/**
 * The second section. Replaces the old value bar / static phone, which just
 * restated the hero's "always winning" line.
 *
 * Left: concrete reasons owners hire us — each a distinct promise, not a
 * paraphrase of the headline. Right: the looping phone showing the product doing
 * those things. Reasons and proof, side by side.
 */
...
export default function WhyOwnersHireUs() {
  ...
  return (
    ...
    >
      <div className="split-phone-grid" style={{ maxWidth: 1120, margin: "0 auto", padding: "96px 32px" }}>
        <div>
          <motion.div
