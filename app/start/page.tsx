        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "hasOfferCatalog": {
            ...
            "itemListElement": [
              ...
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Paid Ads Management", "description": "Google, Meta, and LSA campaign management. Quoted per account. No markup on ad spend." }, "priceSpecification": { "@type": "UnitPriceSpecification", "minPrice": "497", "priceCurrency": "USD", "billingDuration": "P1M" } },
              { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Answering Bot", "description": "Chat and voice bot that answers leads, quotes jobs, and books calls 24/7. One-time setup $497 to $747, waived on SIMPL Pro." }, "priceSpecification": { "@type": "UnitPriceSpecification", "minPrice": "147", "maxPrice": "447", "priceCurrency": "USD", "billingDuration": "P1M" } },
