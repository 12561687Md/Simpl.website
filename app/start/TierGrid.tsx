...
const TIERS = [
  ...
  },
  {
    ...
    cadence: "one-time",
    tag: "See everything",
    desc: "The scanner shows you 5 issues. The report shows all of them, and tells you which ones are costing the most. Every finding across all six categories, prioritized by severity and grouped by what to fix first. This is the document you hand to your developer, your marketing person, or us.",
    bullets: [
      "Complete audit across all 6 scoring categories",
      "Every finding prioritized by cost and effort",
      "Social presence and GBP breakdown",
